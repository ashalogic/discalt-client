...
//   const data = (window as any).document.getElementById("data").value;
...
//   const password = window.prompt("Password");
//   const encryptedData = (window as any).document.getElementById("encryptedData").value;
...
const getPasswordKey = (password: any) =>
...
const cryptoAPI = { encryptData: encryptData, decryptData: decryptData };
